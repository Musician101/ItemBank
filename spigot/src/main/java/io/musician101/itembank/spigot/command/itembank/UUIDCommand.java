...
public class UUIDCommand extends AbstractSpigotCommand
{
    public UUIDCommand()
    {
        super(Commands.UUID_NAME, Commands.UUID_DESC, new SpigotCommandUsage(Arrays.asList(new SpigotCommandArgument(Commands.IB_CMD), new SpigotCommandArgument(Commands.UUID_NAME), new SpigotCommandArgument(Commands.PLAYER, Syntax.REQUIRED))), new SpigotCommandPermissions(Permissions.UUID, false, Messages.NO_PERMISSION, Messages.PLAYER_CMD));
    }
